...
//ready to reproduce if it has consumed enough food and is not dying
...
{
  //set radiusToShrinkBy to size of child so over next frames will reduce down in size
  radiusToShrinkBy = width; //shrink by the size of the child now
...
void Microbe::produceChild()
{
  ...
  childMicrobe->setDamping(0.9f + dampingVariation);
